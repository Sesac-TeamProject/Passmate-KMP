...
struct PortOnePaymentView: UIViewRepresentable {
    ...
    static func buildHtml(_ request: PortOneRequest) -> String {
        ...
        <html lang="ko">
          ...
          <body style="margin:0;font-family:sans-serif;display:flex;align-items:center;justify-content:center;height:100vh;color:\(PassmateColors.textSecondaryCssHex)">
            <p>결제창을 여는 중이에요…</p>
            <script>
